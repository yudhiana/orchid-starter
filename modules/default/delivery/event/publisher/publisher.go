...
func (p *EventPublisher) PublishDefaultCreated(ctx context.Context, exchange, routingKey string, kind rabbitmq.Kind, msg rabbitmq.Publishing) error {
	return p.publishing.Publish(ctx, exchange, routingKey, kind, msg)
}

func (p *EventPublisher) PublishQueueDefaultCreated(ctx context.Context, queue string, msg rabbitmq.Publishing) error {
